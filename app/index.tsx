...
const pieData = [
  { name: 'Car Payment', amount: 9999, color: '#A78BFA', legendFontColor: '#fff' },
  { name: 'Games', amount: 4444, color: '#FFD700', legendFontColor: '#fff' },
  { name: 'Food', amount: 7777, color: '#87CEEB', legendFontColor: '#fff' },
  { name: 'Home spends', amount: 8888, color: '#FF69B4', legendFontColor: '#fff' },
]
  ...
  return (
    <ScrollView className="flex-1 bg-zinc-900">
      ...
      <View className="flex-row justify-between items-center p-4">
        <Text className="text-white text-2xl font-semibold">Welcome, Nicolas</Text>
      ...
      {/* Balance Cards */}
      <View className="flex-row mx-4 space-x-4 mb-6 gap-6">
        <View className="flex-1 bg-red-400 p-4 rounded-xl">
          <View className="flex-row items-center space-x-2 mb-1 gap-2">
            ...
            <Text className="text-zinc-900 text-lg font-semibold">Total Spent</Text>
          </View>
        ...
        <View className="flex-1 bg-violet-500 p-4 rounded-xl">
          <View className="flex-row items-center space-x-2 mb-1 gap-2">
            <CreditCard size={22} color="#18181b" />
            <Text className="text-zinc-900 text-lg font-semibold">Available Balance</Text>
          </View>
          <Text className="text-zinc-900 text-xl font-bold">$999.000</Text>
        </View>
      </View>
